    ...
    <div class="container">
        ...
        <div class="row align-items-center text-center text-md-left">
            <div class="col-md-6 col-lg-5 mb-5 mb-md-0">
                <h2 style="color:darkslateblue">Tentang Sistem Pakar Diagnosis Kerusakan Mobil Transmisi Otomatis</h2>
                <br/>
                <p ><h5 style="color:black;text-align:justify "> Kerusakan pada mobil sebagian besar terjadi akibat kelalaian melakukan perawatan pada mobil, baik itu dikarenakan kesibukan pemakai atau pengetahuan yang minim dalam perawatan mobil yang digunakan. Oleh karena itu pemilik mobil membutuhkan suatu perawatan secara bekala dengan cara mendeteksi gejala apa saja yang terjadi pada mobil tersebut.
                    Perlunya dibuat sistem pakar berbasis web untuk diagnosis kerusakan mobil transmisi otomatis adalah untuk membantu masyarakat khususnya pengguna mobil untuk memahami dan mengenali gejala kerusakan yang ada pada mobil, Dengan demikian program ini akan memberikan pembelajaran kepada masyarakat khususnya pengendara mobil akan pentingnya teknologi informasi yang bisa dimanfaatkan sebagai penyedia informasi tentang berbagai ciri-ciri kerusakan mobil. <h5>
                </p>
            </div>
