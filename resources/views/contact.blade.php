    ...
    <div class="container">
        ...
        <div class="row align-items-center text-center text-md-left">
            <div class="col-md-6 col-lg-5 mb-5 mb-md-0">
                <h2 style="color:darkslateblue">Jika ada pertanyaan seputar masalah sistem pakar silahkan hubungi contact di bawah ini : </h2>
                <br/>
                <h3 style="color:black">Email : imamaji73@gmail.com </h3>
                <h3 style="color:black">Nomor telp : 081288142244</h3>
            </div>
