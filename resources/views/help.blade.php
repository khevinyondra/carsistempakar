    ...
    <div class="container">
        ...
        <div class="row align-items-center text-center text-md-left">
            <div class="col-md-6 col-lg-5 mb-5 mb-md-0">
                <h2 style="color:darkslateblue">Panduan menggunakan website sistem pakar ini :</h2>
                <h6 style="color:black "> 1. Pengguna klik "mulai" untuk melakukan diagnosis </br> 2. Pengguna mengisi form data diri dan domisili </br>
        3. pengguna memilih salah satu gejala awal yang dirasakan </br> 4. pengguna bisa memilih beberapa gejala berikut nya </br> 5. kemudian akan keluar hasil diagnosa berdasarkan gejala yang user pilih<h6>
                </p>
            </div>
